      ...
      <div class="block80">
        <form class="" action="" method="post" enctype="multipart/form-data">
          <fieldset>
            ...
            <div class="infoclub">
              <label class="textlabel" for="texte"><?php echo lang("Message") ?></label>
              <input value="<?php echo $_POST['texte']?>" type="text"  class="inputfieldset" name="texte" placeholder="" required >
            </div>
            <div class="infoclub">
              <label class="textlabel" for="id_topic"><?php echo lang("id Topic") ?></label>
