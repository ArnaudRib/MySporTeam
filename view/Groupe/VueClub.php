  ...
  <div id="corps_mongroupe">
    <div class="cote_informations">
      <div class="radius_mongroupe forme_case">
        <div class="titre">
          <h1><?php echo lang("Informations Club") ?></h1>
        </div>
        <div>
      ...
      <div class="radius_mongroupe forme_case">
        <div class="titre">
          <h1><?php echo lang("Contacter le Club") ?></h1>
        </div>
        <div>
          <h2> <?php echo lang("Adresse") ?> : </h2>
