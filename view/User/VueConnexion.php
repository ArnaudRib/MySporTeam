...
<div id="inscription">
  <form action="" method="post">
    ...
    <fieldset>
      <div>
        <label for="login"><img src="/mysporteam/asset/images/Users/icone_utilisateur.png" /></label>
        <input type="text" name="pseudo" placeholder="Email ou Pseudo" required>
      </div> <br />

      <div><label for="mdp"><img src="/mysporteam/asset/images/Users/icone_lock.png" /></label>
