...
<nav id="inscription">
  <form action="" method="post">
    ...
    <fieldset>
      ...
      <br />
      <div><label for="pseudo"><img src="/mysporteam/asset/images/Users/icone_utilisateur.png" /></label>
      <input type="text" name="pseudo" placeholder="Identifiant" required></div> <br />

      <div><label for="email" class="email"><img src="/mysporteam/asset/images/Users/icone_email.png" /></label>
      <input type="text" name="email" placeholder="Email" required></div> <br />

      <div><label for="password"><img src="/mysporteam/asset/images/Users/icone_lock.png" /></label>
      <input id="mdp" type="password" name="mot_de_passe" placeholder="Mot de passe" oninput="Verification()" required></div> <br />

      <div><label for="check_psswd"><img src="/mysporteam/asset/images/Users/icone_lock.png" /></label>
